 ...
 *
 */
public interface IExpr extends ILabel {
	/**
	 * 
	 * @return type of the expression. For array terms, the type is always represented as pure reference (dOwn=0 and dRef=dTot).
	 * @see IType
	 */
	public IType type();
}
