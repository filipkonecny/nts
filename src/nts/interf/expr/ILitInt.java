...
/**
 * A non-negative integer literal. Note that negative integers are represented by the unary 
 * operator MINUS and a non-negative integer literal as its operand.
 *
 */
