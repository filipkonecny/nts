...
/**
 * A non-negative real-type literals. Note that negative real numbers are represented by the unary 
 * operator MINUS and a non-negative real-type literal as its operand.
 *
 */
public interface ILitReal extends IExpr {
	public float value();
}
