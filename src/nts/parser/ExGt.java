...
public class ExGt extends OpBinRel implements IExprGt {
	...
	public ExGt(Expr aE1, Expr aE2) { this(null,aE1,aE2); }
	public ExGt(Token aT, Expr aE1, Expr aE2) { super(aT,aE1,aE2); }
	
	public static ExGt createRev(Token aT, Expr aE2, Expr aE1) { return new ExGt(aT,aE1,aE2); }
	
	ExGt syn_copy() { return new ExGt(Common.copyToken(token),op1.syn_copy(),op2.syn_copy()); }
}
